...
//                $_POST[BaseConstants::CACCOUNT] = $this->validateFormData("number", BaseConstants::CACCOUNT, $_POST[BaseConstants::CACCOUNT]);
    ...
    public function check_email() {
        echo $this->userModel->check_email($_POST["uemail"],$_POST["usertype"]);
    }

    public function check_pass() {
        echo $this->userModel->check_pass($_POST["upass"]);
    }
    public function check_phone() {
        echo $this->userModel->check_phone($_POST["uphone"],$_POST["usertype"]);
    }
