            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    foreach ($data['variantData'] as $key => $value)
                    {
                        ...
                        $totalAmount= ( ($value['final_price']) * ($_SESSION['variantdata'][$value['variant_id']]) )+$totalAmount;
                        ?>
                        <tr>
                            <td style="text-align: left;"><img src="http://samrons.local/images.php?filename=<?php echo $value['vendor_auto_id']?>/<?php echo  $value['product_auto_id']?>_<?php echo  $value['variant_auto_id']?>/<?php echo $value['product_image']?>" alt="" style="width: 50px;">   <b><?php echo $value['name']?></b></td>
                            <td class="align-middle"><b><span>&#8377; </span></b><?php echo $value['final_price']?></td>
                            ...
                            <td class="align-middle"><b><span>&#8377; </span></b><?php echo ($value['final_price']) * ($_SESSION['variantdata'][$value['variant_id']])  ?></td>
