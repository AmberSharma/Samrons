                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                                <div class="card product-item border-0 mb-4">
                                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                        <img  style="height: 312px; width: 312px;" class="img-fluid w-100"
                                             src="http://samrons.local/images.php?filename=<?php echo $productData['vendor_auto_id'] ?>/<?php echo $productData['product_auto_id'] ?>_<?php echo $productData['variant_auto_id'] ?>/<?php echo $productData['product_image'] ?>"
                                             alt="">
                                    </div>
                                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                        <h6 class="text-truncate mb-3"><?php echo $productData['name'] ?></h6>
                                        <div class="d-flex justify-content-center">
                                            <h6><?php echo $productData['final_price'] ?></h6>
                                            <h6 class="text-muted ml-2">
                                                <del><?php echo $productData['mrp'] ?></del>
                                            </h6>
                                        </div>
                                    </div>
