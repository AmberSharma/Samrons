...
<body>
    <!-- Left Panel -->
    <?php include_once "inc/leftpanel.php"; ?>
    <!-- /#left-panel -->
    <!-- Right Panel -->
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <?php
                    foreach($data["dashboardData"]["header"] as $key => $value) {
                        ?>
                                    ...
                                    <div class="stat-widget-five">
                                        ...
                                        <div class="stat-content">
                                            <div class="text-left dib">
                                                <div class="stat-text"><span class="count"><?php echo $value["count"]; ?></span></div>
                                                <div class="stat-heading"><?php echo $value["name"]; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--                    </div>-->
    ...
    <script src="<?php echo ASSETS ?>js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="<?php echo ASSETS ?>js/init/fullcalendar-init.js"></script>
