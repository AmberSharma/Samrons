                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner border">
                        ...
                        <div class="carousel-item <?php if($key == 0) echo 'active';?>">
                            <img class="w-100 h-100" src="http://samrons.local/images.php?filename=<?php echo  $data['productdata'][0]['vendor_id']?>/<?php echo  $data['productdata'][0]['id']?>_<?php echo  $data['variant_ids'][$key]?>/<?php echo $image?>" alt="Image">
                        </div>
                        <?php }?>
                ...
                <div class="d-flex mb-3">
                    ...
                    <form>
                        ...
                        <div  id="variantOption" class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="<?php echo $key."-".$count; ?>" name="<?php echo $key ?>[]" value="<?php echo ucfirst($Option )?>">
