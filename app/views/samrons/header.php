...
<head>
    <meta charset="utf-8">
    <title><? echo $data["page_title"]; ?></title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="<?php echo ASSETS ?>img/favicon.ico" rel="icon">
    ...
    <script type="text/javascript" src="<?php echo ASSETS ?>js/lib/easing/easing.min.js"></script>
